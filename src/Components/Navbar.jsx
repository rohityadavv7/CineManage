   ...
   <div className='navbar flex flex-col'>
        <div className="navbar bg-base-100">
            <div className="navbar-start">
                <div className="drawer">
                    ...
                    <div className="drawer-content">
                        {/* Page content here */}
                        <button>
                            <label htmlFor="my-drawer" className="btn  drawer-button rounded-lg"><HiOutlineMenuAlt1 /></label>
                        </button>
                    </div>
            ...
            <div className="navbar-center">
                <Link to="/">
                    <p className="btn btn-ghost text-xl rounded-lg font-normal">CineManage</p>
                </Link>
            </div>
